...
/**
 * Beschreibt die (prim�re) SD-Karte in {@link Device}-Form. Interessant f�r 
 ...
 * 
 * TODO Die Erkennung, ob es sich um ein Ger�t mit fester SD-Karte handelt,
 * findet nicht hier statt. {@link #isRemovable()} liefert also TRUE, zumindest
 * solange in {@link DeviceUtils#rescanDevices()} kein Hack durchgef�hrt
 * wird.
 * 
 * @author Jockel
 * 
 * @version 1.2 - API7 wird unterst�tzt
 *
 */
class DeviceExternal extends Device {
	...
	@Override
	public String getName() { return mRemovable ? "SDCARD" : "Internal 2"; }
